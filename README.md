...
- [ ] Describe Middleware?
      A bunch of code executed before the main action to check if all requests passing have the right body, has right properties etc. Essentially for authorization and authentication purposes.
- [ ] Describe a Resource?
...
* [ ] How can we partition our application into sub-applications?
      A combination of routing and importing functions. I like my middleware separate from all http related stuff, for example, for easier maintenance.
